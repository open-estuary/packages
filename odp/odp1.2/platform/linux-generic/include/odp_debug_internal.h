...
#define ODP_DEBUG (1)       /*added by h64632 2015-03-20 for compiling*/
#define ODP_DEBUG_PRINT (1) /*added by h64632 2015-03-20 for compiling*/
...
#define ODP_LOG(level, fmt, ...) \
	odp_global_data.log_fn(level, "¡¾Func: %s. Line: %d¡¿" fmt, __func__, __LINE__, ##__VA_ARGS__)
