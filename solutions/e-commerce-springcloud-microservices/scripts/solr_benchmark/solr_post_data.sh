...
${post_cmd} -c "${core}" -p "${port}" -host "${host}" ${data} -filetypes csv -params "fieldnames=description,quatity,productid,size,cateid,price,title,url,manufacturer&header=true" -params "separator=%09"
