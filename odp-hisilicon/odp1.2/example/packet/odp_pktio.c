...
static odp_pktio_t create_pktio(const char *dev, odp_pool_t pool, int mode)
{
    ...
    printf("  created pktio:%02d, dev:%s, queue mode (ATOMIC queues)\n"
...
static void *pktio_queue_thread(void *arg)
{
    ...
    printf("  [%02i] looked up pktio:%02d, queue mode (ATOMIC queues)\n"
           "         default pktio%02d-INPUT queue:%d\n",
...
static void *pktio_ifburst_thread(void *arg)
{
    ...
    printf("  [%02i] looked up pktio:%02d, burst mode\n",
