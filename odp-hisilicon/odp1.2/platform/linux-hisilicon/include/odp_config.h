...
#undef ODP_LIBNAME
#define ODP_LIBNAME "intel_dpdk"
#undef ODP_LIBODP
#define ODP_LIBODP 1
#undef ODP_MAX_MEMSEG
#define ODP_MAX_MEMSEG 128
#undef ODP_MAX_MEMZONE
#define ODP_MAX_MEMZONE 128
#undef ODP_MAX_TAILQ
...
#undef ODP_LIBODP_VMWARE_TSC_MAP_SUPPORT
#define ODP_LIBODP_VMWARE_TSC_MAP_SUPPORT 1
