 ...
 */
 #if  1
extern uint16_t __arch_swab16(uint16_t x);
extern uint32_t __arch_swab32(uint32_t x);

static inline uint16_t odp_be_to_cpu_16(uint16be_t be16)
{
#if ODP_BYTE_ORDER == ODP_LITTLE_ENDIAN
	return __arch_swab16((__odp_force uint16_t)be16);
#else
...
{
#if ODP_BYTE_ORDER == ODP_LITTLE_ENDIAN
	return __arch_swab32((__odp_force uint32_t)be32);
#else
...
{
#if ODP_BYTE_ORDER == ODP_LITTLE_ENDIAN
	return (__odp_force uint16be_t)__arch_swab16(cpu16);
#else
...
{
#if ODP_BYTE_ORDER == ODP_LITTLE_ENDIAN
	return (__odp_force uint32be_t)__arch_swab32(cpu32);
#else
...
#else
	return __arch_swab16((__odp_force uint16_t)le16);
#endif
}
...
#else
	return __arch_swab32((__odp_force uint32_t)le32);
#endif
}
...
#else
	return (__odp_force uint16le_t)__arch_swab16(cpu16);
#endif
}
...
#else
	return (__odp_force uint32le_t)__arch_swab32(cpu32);
#endif
}
